...
public class Cliente extends Usuario {
    ...
    //    //update
    public void actualizarCliente(String nuevoNombre, String nuevaDireccion, String nuevoTelefono, String nuevoCorreo, String nuevaContrasena) {
        // Comprobar si el cliente existe
        Cliente clienteExistente = (Cliente) comprobador.comprobarExistencia(this.getCedula(), gimnasio.getListaClientes());
        if (clienteExistente != null) {
            // Actualizar los datos del cliente utilizando los métodos set
